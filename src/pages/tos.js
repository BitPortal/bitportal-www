                        ...
                        <div className="row">
                            <div className="col-sm-12">
                                <section className="wrapper">
                                    ...
                                    <p className="strong mb">感谢您选择BitPortal服务。《BitPortal服务协议》（以下简称“本协议”）由上海帕特里夏网络科技有限公司（以下简称“帕特里夏”或“我们”）和用户（以下简称“您”或“用户”）签订，本协议在您与帕特里夏之间具有合同上的法律效力。</p>
                                    <p className="strong mb">帕特里夏在此特别提醒您在使用BitPortal（以下简称“BitPortal”
                                    ...
                                    <section className="terms-area">
                                        ...
                                        <ul className="strong">
                                            <li>1.
                                                您理解本协议及有关协议适用于BitPortal及BitPortal上帕特里夏所自主开发和拥有的去中心化应用（简称“DApp”）（排除第三方开发的DApp）。
                                            </li>
                                            <li>2. 您下载BitPortal软件并创建或导入钱包，即视为您已经充分阅读并接受本协议全部条款，本协议立即生效，对双方具有约束力。
                                            </li>
                                            <li>3.
                                                本协议可由帕特里夏随时更新，经修改的协议一经在BitPortal上公布，立即自动生效，恕不再另行通知。在帕特里夏公布修改协议条款后，如果您不接受修改后的条款，请立即停止使用BitPortal，您继续使用BitPortal将被视为接受修改后的协议。
                                            </li>
                                    ...
                                    <section className="terms-area">
                                        <h2>二、 定义</h2>
                                        <ul>
                                            <li><span className="strong">1. BitPortal：</span>指由帕特里夏基于EOS单链系统（及将来陆续支持的其他区块链系统）开发的区块链钱包，包括其他为方便用户使用区块链系统而开发的辅助工具。
                                            </li>
                                            <li>
                                            ...
                                            <li><span className="strong">5. 钱包密码：</span>指您在创建BitPortal钱包过程中，软件操作界面提示您填写的密码，该密码用于加密保护私钥。作为去中心化的应用，钱包密码不存储在您的这台移动设备或帕特里夏的服务器，一旦丢失你需要借助明文私钥或助记词重置新密码。
                                            </li>
                                            <li><span className="strong">6. 信息提示：</span>BitPortal软件操作界面涉及的信息提示内容，建议用户按照相关步骤进行操作。
                                            </li>
                                            <li><span className="strong">7. 特定用户：</span>指按照中国法律法规及政策规定必须要配合帕特里夏履行个人信息披露义务的用户。
                                            </li>
                                            ...
                                            <li><span className="strong">13. 资料：</span>指BitPortal上“浏览”、“市场”等版块的文章等资料，这些资料均为帕特里夏所有，未经授权不得转载。
                                            </li>
                                    ...
                                    <section className="terms-area">
                                        ...
                                        <ul>
                                            ...
                                            <li><span className="strong">5. 浏览DApp。</span>用户通过在BitPortal上的链接，可以跳转至DApp并使用该DApp（包括帕特里夏自己的DApp和第三方DApp）提供的服务。
                                            </li>
                                            ...
                                            <li>8. 其他帕特里夏认为有必要提供的服务。</li>
                                        </ul>
                                        <p className="strong">用户接受帕特里夏提供的上述服务时应了解以下常见问题：</p>
                                        <ul className="strong">
                                            <li>1.
                                                秉承着区块链的去中心化特点，并为了保护用户的数字代币安全，帕特里夏提供的是去中心化服务，大大区别于银行业金融机构。用户了解，帕特里夏不提供以下服务：
                                                <ul>
                                            ...
                                            <li>2.
                                                由于帕特里夏不提供上述服务，因此用户应当自行保管含有BitPortal的移动设备、备份BitPortal、备份钱包密码、助记词、私钥及Keystore。如用户遗失移动设备、删除且未备份BitPortal、删除且未备份钱包、钱包被盗或遗忘钱包密码、私钥、助记词、Keystore，帕特里夏均无法还原钱包或找回钱包密码、私钥、助记词、Keystore；如用户进行交易时误操作（例如输错转账地址），帕特里夏亦无法取消交易。
                                            </li>
                                            <li>3.
                                                帕特里夏和BitPortal所能够提供的数字代币管理服务并未包括所有已存在的数字代币，请勿通过BitPortal操作任何BitPortal不支持的数字代币。
                                            </li>
                                            <li>4.
                                                BitPortal仅是用户的数字代币管理工具，并非交易所或交易平台。虽然本协议将多次提及“交易”，其行为泛指用户使用BitPortal进行的转账和收款操作，这与交易所或交易平台上进行的“交易”有本质区别。
                                            </li>
                                            <li>5.
                                                BitPortal上集成的DApp包括帕特里夏自主拥有的DApp和第三方平台提供的DApp。对于第三方平台提供的DApp，BitPortal仅为用户进入DApp提供区块链浏览器。用户在第三方DApp上接受服务或进行交易前应自行判断和评估该第三方DApp提供的服务或交易是否存在风险。
                                            </li>
                                        </ul>
                                    </section>
                                    <section className="terms-area">
                                        ...
                                        <ul>
                                            ...
                                            <li>3. 帕特里夏可能为不同的终端设备开发不同的软件版本，您应当根据实际需要选择下载合适的版本进行安装。<span
                                                className="strong">如果您从未经合法授权的第三方获取本软件或与本软件名称相同的安装程序，帕特里夏将无法保证该软件能否正常使用，也无法保证其安全性，因此造成的损失由您自行承担。</span>
                                            </li>
                                            <li className="strong">4.
                                                本软件新版本发布后，旧版软件可能无法使用。帕特里夏不保证旧版软件的安全性、继续可用性及提供相应的客户服务。请您随时核对并下载最新版本。
                                            </li>
                                        </ul>
                                        <h4>（二）使用</h4>
                                        <ul>
                                            <li>1.<span
                                                className="strong">用户应自行妥善保管移动设备、钱包密码、私钥、助记词、Keystore等信息。帕特里夏不负责为用户保管以上信息。因您遗失移动设备、主动或被动泄露、遗忘钱包密码、私钥、助记词、Keystore或遭受他人攻击、诈骗等所引起的一切风险、责任、损失、费用应由您自行承担。</span>
                                            </li>
                                            ...
                                            <li>
                                                ...
                                                <ul className="strong">
                                                    ...
                                                    <li>（4）您知悉BitPortal仅向您提供转账工具，在您使用BitPortal完成转账后，帕特里夏即完成了当次服务的所有义务，帕特里夏对其他纠纷争议，不负担任何义务。</li>
                                                </ul>
                                            </li>
                                    ...
                                    <section className="terms-area">
                                        ...
                                        <ul className="strong">
                                            ...
                                            <li>3.
                                                在您使用BitPortal集成的第三方DApp服务或进行交易时，为了您的利益，帕特里夏建议您仔细阅读本协议及BitPortal提示，了解交易对象及产品信息，谨慎评估风险后再采取行动。所有您在第三方DApp进行的交易行为系您的个人行为，有约束力的合同关系在您和您的相对方之间建立，与BitPortal无关。BitPortal对因您的交易行为所引起的一切风险、责任、损失、费用不承担任何责任。
                                            </li>
                                            ...
                                            <li>6.
                                                您理解当您在BitPortal上创建或导入钱包之后，您的Keystore、私钥、助记词等信息仅存储在当前的这台移动设备中，不存储在BitPortal或帕特里夏的服务器上。您可以按照BitPortal提供的操作指南采取同步钱包等方式更换移动设备。但若您未保存或备份钱包密码、私钥、助记词、Keystore等信息且在您移动设备丢失的情况下，您的数字代币将因此丢失，帕特里夏无法为您找回，您需自行承担相应损失。若您在导出、保存或备份钱包密码、私钥、助记词、Keystore等信息的时候泄密，或保存或备份上述信息的设备或服务器被黑客攻击或控制等情况下，您的数字代币将因此丢失，帕特里夏无法为您找回，您需自行承担相应损失。
                                            </li>
                                            <li>7.
                                    ...
                                    <section className="terms-area">
                                        ...
                                        <ul className="strong">
                                            <li>1.
                                                您同意帕特里夏为保证自主业务经营权可以暂时提供部分服务功能，或于将来暂停部分服务功能或开通新的服务功能。当任何功能减少或者增加或者变化时，只要您仍然使用帕特里夏提供的服务，表示您仍然同意本协议或者本协议修正后的条款。
                                            </li>
                                            <li>2.
                                                为保护您的数字代币安全，尽量避免您在不具备区块链基础知识的前提下使用BitPortal而产生的误操作或由此带来的风险，您必须先通过能力测评问卷并达到帕特里夏所要求的合格分数才能使用BitPortal服务，否则，帕特里夏有权限制或拒绝提供部分或全部的服务功能。
                                            </li>
                                            <li>3. 您理解存在如下情形时，帕特里夏将暂停提供服务：
                                                <ul>
                                                    <li>（1）因设备、区块链系统维修、升级、故障和通信中断等技术原因而中断业务；</li>
                                                    <li>（2）因台风、地震、海啸、洪水、停电、战争或恐怖袭击等不可抗力因素，病毒、木马、黑客攻击、系统不稳定或政府行为等原因，造成帕特里夏系统不能提供服务或帕特里夏合理认为继续提供服务会有较大风险的；</li>
                                                    <li>（3）发生帕特里夏无法控制或合理预见的其他情形。</li>
                                                </ul>
                                            </li>
                                            <li>3. 当您出现如下情况时，帕特里夏可单方面中止或终止您使用BitPortal的部分或全部功能:
                                                <ul>
                                                    <li>（1）用户死亡；</li>
                                                    <li>（2）盗用他人的钱包信息或移动设备；</li>
                                                    <li>（3）填写个人信息时提供虚假信息、在回答能力测评问卷时非本人操作；</li>
                                                    <li>（4）拒绝帕特里夏为提升BitPortal功能而发起的强制更新操作；</li>
                                                    <li>（5）将BitPortal用于违法或犯罪活动；</li>
                                                    <li>（6）妨碍其他用户正常使用；</li>
                                                    <li>（7）伪称帕特里夏的工作人员或管理人员；</li>
                                                    <li>（8）攻击、侵入、更改或以任何其他方式威胁帕特里夏计算机系统的正常运作；</li>
                                                    <li>（9）利用BitPortal宣传垃圾广告；</li>
                                                    <li>（10）散布谣言，损害帕特里夏和BitPortal商誉；</li>
                                                    <li>（11）违法行为，其他违反本协议的行为，及帕特里夏合理认为应当暂停功能的情形。</li>
                                                </ul>
                                            </li>
                                            <li>4. 当您与帕特里夏之间的服务关系变更、中断、终止时，您仍有权在合理时间内导出您钱包等信息。</li>
                                        </ul>
                                    </section>
                                    <section className="terms-area">
                                        <h2>七、 您合法使用帕特里夏服务的承诺</h2>
                                        <ul className="strong">
                                            <li>1.
                                                您应遵守中华人民共和国相关法律法规及您所居住的国家或地区的法律法规，不得将BitPortal用于任何非法目的，也不得以任何非法方式使用帕特里夏服务。
                                            </li>
                                            <li>2. 您不得利用BitPortal从事违法或犯罪的行为，包括但不限于：
                                                <ul>
                                                    <li>（1）反对宪法所确定的基本原则，危害国家安全、泄漏国家秘密、颠覆国家政权、破坏国家统一的；</li>
                                                    <li>（2）从事任何违法犯罪行为，包括但不限于洗钱、非法集资等；</li>
                                                    <li>（3）通过使用任何自动化程序、软件、引擎、网络爬虫、网页分析工具、数据挖掘工具或类似工具，接入帕特里夏服务、收集或处理帕特里夏所提供的内容，干预或试图干预任何用户或任何其他方式接入帕特里夏服务的行为；</li>
                                                    ...
                                                    <li>（8）其他违法以及帕特里夏有正当理由认为不适当的行为。</li>
                                                </ul>
                                            </li>
                                            <li>3.
                                                您理解并同意，如因您违反有关法律（包括但不限于海关及税务方面的监管规定）或者本协议之规定，使帕特里夏遭受任何损失、受到任何第三方的索赔或任何行政管理部门的处罚，您应对帕特里夏进行赔偿，包括合理的律师费用。
                                            </li>
                                            <li>4. 您承诺按时缴纳帕特里夏的服务费用（如有），否则帕特里夏有权暂停或中止对您提供的服务。</li>
                                        </ul>
                                    </section>
                                    <section className="terms-area">
                                        <h2>八、 隐私条款</h2>
                                        <ul className="strong">
                                            <li>1. 帕特里夏十分重视对用户隐私的保护，相关隐私保护政策请参考帕特里夏公布并不时更新的《BitPortal隐私政策》。</li>
                                        </ul>
                                    </section>
                                    <section className="terms-area">
                                        <h2>九、 免责及责任限制</h2>
                                        <ul className="strong">
                                            <li>1. 帕特里夏仅对本协议中所列明的义务承担责任。</li>
                                            <li>2.
                                                您理解和同意，在法律所允许的范围内，帕特里夏只能按照现有的技术水平和条件提供服务。因下列原因导致BitPortal无法正常提供服务，帕特里夏不承担责任：
                                                <ul>
                                                    <li>（1）BitPortal系统停机维护或升级；</li>
                                                    <li>（2）因台风、地震、洪水、雷电或恐怖袭击等不可抗力原因；</li>
                                                    <li>（3）您的移动设备软硬件和通信线路、供电线路出现故障的；</li>
                                                    <li>（4）您操作不当或未通过帕特里夏授权或认可的方式使用帕特里夏服务的；</li>
                                                    <li>（5）因病毒、木马、恶意程序攻击、网络拥堵、系统不稳定、系统或设备故障、通讯故障、电力故障、银行等原因或政府行为等原因；</li>
                                                    <li>（6）非因帕特里夏的原因而引起的任何其它原因。</li>
                                                </ul>
                                            </li>
                                            <li>3. 帕特里夏对以下情形不承担责任：
                                                <ul>
                                                    <li>（1）因用户遗失移动设备、删除且未备份BitPortal、删除且未备份钱包、钱包被盗或遗忘钱包密码、私钥、助记词、Keystore而导致的数字代币丢失；</li>
                                                    <li>（2）因用户自行泄露钱包密码、私钥、助记词、Keystore，或借用、转让或授权他人使用自己的移动设备或BitPortal钱包，或未通过帕特里夏官方渠道下载BitPortal应用程序或其他不安全的方式使用BitPortal应用程序导致的数字代币丢失；</li>
                                                    <li>（3）因用户误操作（包括但不限于您输错转账地址、您自身选择转账节点服务器的问题）导致的数字代币丢失；</li>
                                                    <li>（4）因用户不理解区块链技术的性质而进行误操作导致的数字代币丢失；</li>
                                                    <li>（5）因时间滞后、区块链系统不稳定等原因导致帕特里夏拷贝用户在区块链上的交易记录发生偏差；</li>
                                                    <li>（6）用户在第三方DApp上操作产生的风险和后果。</li>
                                                </ul>
                                            </li>
                                            <li>4.
                                                您理解BitPortal仅作为您数字代币管理的工具。帕特里夏不能控制第三方DApp提供的产品及服务的质量、安全或合法性，信息的真实性或准确性，以及相对方履行其在与您签订的协议项下的各项义务的能力。所有您在第三方DApp进行的交易行为系您的个人行为，有约束力的合同关系在您和您的相对方之间建立，与BitPortal无关。帕特里夏提醒您应该通过自己的谨慎判断确定登录DApp及相关信息的真实性、合法性和有效性。您与任何第三方交易所产生的风险亦应由您自行承担。
                                            </li>
                                            <li>5.
                                                帕特里夏可能同时为您及您的交易对手方提供服务，您同意对帕特里夏可能存在的该等行为予以明确豁免任何实际或潜在的利益冲突，并不得以此来主张帕特里夏在提供服务时存在法律上的瑕疵，也不因此而加重帕特里夏的责任或注意义务。
                                            </li>
                                            <li>6. 帕特里夏不提供以下形式的保证：
                                                <ul>
                                                    <li>（1）帕特里夏服务将符合您的全部需求；</li>
                                                    <li>（2）您经由帕特里夏服务取得的任何技术、产品、服务、资讯将符合您的期望；</li>
                                                    <li>（3）帕特里夏从第三方交易所抓取的数字代币市场交易行情等信息的及时性、准确性、完整性、可靠性做出保证；</li>
                                                    <li>（4）您在BitPortal上的交易各方会及时履行其在与您达成的交易协议中各项义务。</li>
                                                </ul>
                                            </li>
                                            <li>7. 在任何情况下，帕特里夏对本协议所承担的违约赔偿责任总额不超过1）0.1个以太币；或2）人民币500元，以较高的为准。</li>
                                            <li>8.
                                                您理解BitPortal仅作为用户管理数字代币、显示交易信息的工具，帕特里夏不提供法律、税务或投资建议等服务。您应当自行向法律、税务、投资方面的专业人士寻求建议，且您在使用我们服务过程中所遭受的投资损失、数据损失等，帕特里夏概不负责。
                                            </li>
                                    ...
                                    <section className="terms-area">
                                        <h2>十、 完整协议</h2>
                                        <ul>
                                            <li>1. 本协议由《BitPortal服务协议》、《BitPortal隐私政策》及帕特里夏不时公布的各项规则（包括“帮助中心”的内容）组成。
                                            </li>
                                    ...
                                    <section className="terms-area">
                                        <h2>十一、 知识产权保护</h2>
                                        <ul>
                                            <li>1. BitPortal系帕特里夏开发并拥有知识产权的应用程序。
                                                BitPortal中显示的任何内容（包括本协议、公告、文章、视频、音频、图片、档案、资讯、资料、商标或标识）的知识产权归帕特里夏或第三方权利人所有。用户仅可为持有和管理数字代币之目的使用BitPortal应用程序及其中的内容。未经帕特里夏或第三方权利人的事先书面同意，任何人不得擅自使用、修改、反向编译、复制、公开传播、改变、散布、发行或公开发表上述应用程序及内容。
                                            </li>
                                        </ul>
                                    </section>
                                    <section className="terms-area">
                                        ...
                                        <ul>
                                            ...
                                            <li>2. 若您和帕特里夏之间发生任何纠纷或争议，首先应友好协商解决，协商不成的，任何一方可提交帕特里夏所在地有管辖权的人民法院管辖。
                                            </li>
                                        </ul>
                                    </section>
                                    <section className="terms-area">
                                        <h2>十三、 其他</h2>
                                        <ul>
                                            <li>1. 如您是中华人民共和国以外用户，您需全面了解并遵守您所在司法辖区与使用帕特里夏服务所有相关法律、法规及规则。</li>
                                            <li>2. 您在使用帕特里夏服务过程中，如遇到任何问题，您可以通过在BitPortal提交反馈等方式联系我们。</li>
                                            <li>3. 您可以在BitPortal中查看本协议。 帕特里夏鼓励您在每次访问BitPortal时都查阅帕特里夏的服务协议。</li>
                                            <li>4. 本协议自2017年9月26日起适用。</li>
                                        </ul>
                                    </section>
                                    <p className="strong last">本协议未尽事宜，您需遵守帕特里夏不时更新的公告及相关规则。</p>
                                    <p className="strong right last">上海帕特里夏网络科技有限公司</p>
                                </section>
                                <section className="wrapper">
                                    <h1>《BitPortal隐私政策》</h1>
                                    <p className="strong center">最近更新于：2017年9月26日</p>
                                    <p className="strong mb">尊敬的用户：</p>
                                    <p className="strong mb">上海帕特里夏网络科技有限公司（以下简称“帕特里夏”或“我们”）尊重并保护用户（以下简称“您”或“用户”）的隐私，您使用BitPortal时，帕特里夏将按照本隐私政策（以下简称“本政策”）收集、使用您的个人信息。</p>
                                    <p className="strong mb">帕特里夏建议您在使用本产品（以下简称“BitPortal”）之前仔细阅读并理解本政策全部内容,
                                        针对免责声明等条款在内的重要信息将以加粗的形式体现。本政策有关关键词定义与帕特里夏《BitPortal服务协议》保持一致。</p>
                                    <p className="strong mb">本政策可由帕特里夏在线随时更新，更新后的政策一旦公布即代替原来的政策，如果您不接受修改后的条款，请立即停止使用BitPortal，您继续使用BitPortal将被视为接受修改后的政策。经修改的政策一经在BitPortal上公布，立即自动生效。</p>
                                    <p className="strong mb">您知悉本政策及其他有关规定适用于BitPortal及BitPortal上帕特里夏所自主拥有的DApp。</p>
                                    <section className="terms-area">
                                        <h2>一、 我们收集您的哪些信息</h2>
                                        ...
                                        <ul>
                                            ...
                                            <li className="strong">3. 您知悉：您在BitPortal
                                                上的钱包密码、私钥、助记词、Keystore并不存储或同步至帕特里夏服务器。帕特里夏不提供找回您的钱包密码、私钥、助记词、Keystore的服务。
                                            </li>
                                            <li>4.
                                            ...
                                            <li>6. 在法律法规允许的范围内，帕特里夏可能会在以下情形中收集并使用您的个人信息无需征得您的授权同意：
                                                <ul>
                                    ...
                                    <section className="terms-area">
                                        ...
                                        <ul>
                                            ...
                                            <li>5. 我们收集您的个人信息进行帕特里夏内部审计、数据分析和研究等，以期不断提升我们的服务水平。</li>
                                            <li>6. 依照《BitPortal服务协议》及帕特里夏其他有关规定，帕特里夏将利用用户信息对用户的使用行为进行管理及处理。</li>
                                    ...
                                    <section className="terms-area">
                                        ...
                                        <ul>
                                            <li>1.
                                                帕特里夏在中华人民共和国境内收集和产生的用户个人信息将存储在中华人民共和国境内的服务器上。若帕特里夏确需向境外传输您的个人信息，将在事前获得您的授权，且按照有关法律法规政策的要求进行跨境数据传输，并对您的个人信息履行保密义务。
                                            </li>
                                            <li className="strong">2. 未经您事先同意，帕特里夏不会将您的个人信息向任何第三方共享或转让，但以下情况除外：
                                                <ul>
                                                    <li>（1） 事先获得您明确的同意或授权；</li>
                                                    <li>（2） 所收集的个人信息是您自行向社会公众公开的；</li>
                                                    <li>（3） 所收集的个人信息系从合法公开披露的信息中收集，如合法的新闻报道，政府信息公开等渠道；</li>
                                                    <li>（4） 与帕特里夏的关联方共享，我们只会共享必要的用户信息，且受本隐私条款中所声明的目的的约束；</li>
                                                    <li>（5） 根据适用的法律法规、法律程序的要求、行政机关或司法机关的要求进行提供；</li>
                                                    <li>（6） 在涉及合并、收购时，如涉及到个人信息转让，帕特里夏将要求个人信息接收方继续接受本政策的约束。</li>
                                                </ul>
                                            </li>
                                        </ul>
                                    </section>
                                    <section className="terms-area">
                                        ...
                                        <ul>
                                            <li>1.
                                                如帕特里夏停止运营，帕特里夏将及时停止继续收集您个人信息的活动，将停止运营的通知公告在BitPortal上，并对所持有的您的个人信息在合理期限内进行删除或匿名化处理。
                                            </li>
                                            <li>2.
                                                为了保护您的个人信息，帕特里夏将采取数据安全技术措施，提升内部合规水平，增加内部员工信息安全培训，并对相关数据设置安全访问权限等方式安全保护您的隐私信息。
                                            </li>
                                            <li>3.
                                    ...
                                    <section className="terms-area">
                                        ...
                                        <ul>
                                            <li>1. 未成年人应当在父母或监护人指导下使用帕特里夏相关服务。</li>
                                            <li>2.
                                    ...
                                    <section className="terms-area">
                                        ...
                                        <ul className="strong">
                                            <li>1.
                                                请您注意，您通过BitPortal接入第三方DApp后，将适用该第三方DApp发布的隐私政策。该第三方DApp对您个人信息的收集和使用不为帕特里夏所控制，也不受本政策的约束。帕特里夏无法保证第三方DApp一定会按照帕特里夏的要求采取个人信息保护措施。
                                            </li>
                                            <li>2. 您应审慎选择和使用第三方DApp，并妥善保护好您的个人信息，帕特里夏对其他第三方DApp的隐私保护不负任何责任。</li>
                                            <li>3.
                                                帕特里夏将在现有技术水平条件下尽可能采取合理的安全措施来保护您的个人信息，以避免信息的泄露、篡改或者毁损。帕特里夏系利用无线方式传输数据，因此，帕特里夏无法确保通过无线网络传输数据的隐私性和安全性。
                                            </li>
                                        </ul>
                                    </section>
                                    <section className="terms-area">
                                        <h2>八、 其他</h2>
                                        <ul>
                                            <li>1. 如您是中华人民共和国以外的用户，您需全面了解并遵守您所在司法辖区与使用帕特里夏服务所有相关法律、法规及规则。</li>
                                            <li>2. 您在使用帕特里夏服务过程中，如遇到任何有关个人信息使用的问题，您可以通过在BitPortal提交反馈等方式联系我们。</li>
                                            <li>3. 您可以在BitPortal中查看本政策及帕特里夏其他服务规则。<span
                                                className="strong">我们鼓励您在每次访问BitPortal时都查阅帕特里夏的服务协议及隐私政策。</span>
                                            </li>
                                            <li>4.
