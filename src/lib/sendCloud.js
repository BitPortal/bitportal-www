...
!function (s, e) {
    ...
    function e(s, e) {
        ...
        c.id = "sendcloud-subscribe-wrapper", c.className = "sendcloud-" + s + "-wrapper", c.innerHTML = g[s], c.querySelector(".subscribe-title").innerHTML = e, "embed" === s ? document.querySelector("#sendcloud-embed-subscribe").appendChild(c) : y.appendChild(c)
    }

    function c(s) {
        for (var e = ["http://sendcloud.sohu.com/css/subscribe.css", "http://sendcloud.sohu.com/css/animate.css"], c = 0; c < e.length; c++) {
            var t = document.createElement("link");
            t.setAttribute("rel", "stylesheet"), t.href = e[c], h.appendChild(t)
        }
    }

    function t() {
        d = b.querySelector(".subscribe-form"), p = b.querySelector(".subscribe-email-input"), m = b.querySelector(".subscribe-submit-btn"), v = b.querySelector(".close");
        var s;
        p.addEventListener("blur", function (e) {
            e.preventDefault(), s = r(this.value), n(s ? "" : "请输入邮箱")
        }), m.addEventListener("click", function (e) {
            e.preventDefault(), s = r(p.value), s && (i(p.value), this.setAttribute("disabled", "true"))
    ...
    function i(s) {
        ...
        e.onload = function () {
            ...
            s.success ? u() : n(s.message)
        }, e.onerror = function () {
            u()
        }, e.open("POST", a.url + "?invitecode=" + a.invitecode + "&email=" + s), e.send()
    }

    function n(s) {
        var e = b.querySelector(".subscribe-msg");
        e.innerText = s
    }
    ...
    function l(s, e) {
        for (var c in e) e[c] && e[c].constructor && "object" === e[c].constructor ? (s[c] = s[c] || {}, anguments.callee(s[c], e[c])) : s[c] = e[c];
        return s
    }

    var a, b, d, p, m, v, f = window.sendcloud = window.sendcloud || {}, y = document.body, h = document.head, g = {
        ...
        title: "閭欢璁㈤槄鎴戜滑鍚э紒",
        successMsg: "璁㈤槄鎴愬姛锛�",
        hiddenClass: {banner: "fadeOutUp", bottom: "fadeOutRight", pop: "bounceOut", embed: "fadeOut"},
