        ...
        return (
            <div className={(this.state.webview === true ? 'webview-page' : null) + ' index-root'}>
                <Helmet htmlAttributes={{"lang": this.state.language}}>
                    <title>{intl.formatMessage({id: 'title.index'})}</title>
                    ...
                    <meta name="description"
                      ...
                      <meta name="keyword" content="BitPortal, 币通, 币通钱包, EOS Wallet, Crypto Wallet, DEX, 多链钱包, Bitcoin, BTC, Ethereum, ETH, Polkadot"/>
